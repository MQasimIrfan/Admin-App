...
function Verification() {  // Renamed from 'verification' to 'Verification'
  ...
  useEffect(() => {
    ...
    const fetchFacialDb = async () => {
      try {
        const images = ["Imran.jpeg"]; // qasim.jpg,Imran.jpg,mark.jpeg
...
export default Verification;  // Renamed from 'verification' to 'Verification'
